...
public class ExtractOrder2 {
    public static void main(String[] args) throws Exception {
        // Load properties
        Properties minioConfig = new Properties();
        try (InputStream stream = ExtractOrder2.class.getClassLoader().getResourceAsStream("minio.properties")) {
            minioConfig.load(stream);
        }
        Properties consumerConfig = new Properties();
        try (InputStream stream = ExtractOrder2.class.getClassLoader().getResourceAsStream("consumer.properties")) {
        ...
        partitionSet.add(new TopicPartition("orders", 2));
